...
#define ir_in_5_Pin GPIO_PIN_6
#define ir_in_5_GPIO_Port GPIOA
#define ir_in_6_Pin GPIO_PIN_7
#define ir_in_6_GPIO_Port GPIOA
#define right_motor_green_Pin GPIO_PIN_0
...
#define ir_led_2_Pin GPIO_PIN_10
#define ir_led_2_GPIO_Port GPIOB
#define ir_led_3_Pin GPIO_PIN_12
#define ir_led_3_GPIO_Port GPIOB
#define ir_led_4_Pin GPIO_PIN_13
#define ir_led_4_GPIO_Port GPIOB
#define ir_led_5_Pin GPIO_PIN_14
#define ir_led_5_GPIO_Port GPIOB
#define ir_led_6_Pin GPIO_PIN_15
#define ir_led_6_GPIO_Port GPIOB
...
#define left_motor_m2_Pin GPIO_PIN_3
#define left_motor_m2_GPIO_Port GPIOB
#define right_motor_m1_Pin GPIO_PIN_4
#define right_motor_m1_GPIO_Port GPIOB
#define right_motor_m2_Pin GPIO_PIN_5
#define right_motor_m2_GPIO_Port GPIOB
